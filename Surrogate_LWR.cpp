...
/*         constructor        */
/*----------------------------*/
SGTELIB::Surrogate_LWR::Surrogate_LWR ( SGTELIB::TrainingSet & trainingset,
...
/*           delete matrices            */
/*--------------------------------------*/
void SGTELIB::Surrogate_LWR::delete_matrices ( void ) {
...
/*               destructor             */
/*--------------------------------------*/
SGTELIB::Surrogate_LWR::~Surrogate_LWR ( void ) {
  delete_matrices();
}//
...
/*          display           */
/*----------------------------*/
void SGTELIB::Surrogate_LWR::display_private ( std::ostream & out ) const {
  out << "q: " << _q << "\n";
}//
...
/*               build                  */
/*--------------------------------------*/
bool SGTELIB::Surrogate_LWR::build_private ( void ) {
...
/*       predict (ZZs only)             */
/*--------------------------------------*/
void SGTELIB::Surrogate_LWR::predict_private ( const SGTELIB::Matrix & XXs,
                                                     SGTELIB::Matrix * ZZs ) {
...
/*--------------------------------------*/
void SGTELIB::Surrogate_LWR::predict_private_single ( const SGTELIB::Matrix XXs , int i_exclude ) {
  ...
  */
    ...
    if (i_exclude==-1){
      std::ofstream myfile;
      const std::string file_name = "LWR_times_n"+itos(_n)+".txt";
...
/*       compute Zvs                    */
/*--------------------------------------*/
const SGTELIB::Matrix * SGTELIB::Surrogate_LWR::get_matrix_Zvs (void){
  check_ready(__FILE__,__FUNCTION__,__LINE__);
  #ifdef SGTELIB_DEBUG
    std::cout << "==========================\n";
